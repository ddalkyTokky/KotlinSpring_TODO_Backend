...
_**- ERD 설계 변경으로 인한 버전업. Member 엔티티에 암호화를 위한 secret 추가.1.0.0 -> 1.1.0**__
...
# 3. DBMS (MYSQL) (1.1.0)
## 3-1. Tables
![todo_list](https://github.com/ddalkyTokky/KotlinSpring_TODO_Backend/assets/47583083/417f0803-0577-478c-925d-b19a9c88a1e6)
## 3-2. DDL
```
CREATE TABLE `member` (
